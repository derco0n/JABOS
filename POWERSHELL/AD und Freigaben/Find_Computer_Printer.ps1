<#
Find's all computers with a specific printer set in its extensionattributes
#>
param (
    [String]$printer="*",
    [string]$outcsv="C:\temp\Druckerzuordnung_"+(Get-Date -Format "yyyyMMdd_HHmmss")+".csv"
)
$printers=Get-ADComputer -filter "extensionattribute1 -like '$printer' -or extensionattribute2 -like '$printer' -or extensionattribute3 -like '$printer' -or extensionattribute4 -like '$printer' -or extensionattribute5 -like '$printer'" -properties Name,extensionattribute1,extensionattribute2,extensionattribute3,extensionattribute4,extensionattribute5 | select-object -property Name,extensionattribute1,extensionattribute2,extensionattribute3,extensionattribute4,extensionattribute5 | ft
$printers | Format-Table
$printers |export-csv -Encoding utf8 -NoTypeInformation -Path $outcsv
#$printers | Out-GridView -PassThru | export-csv -Encoding utf8 -NoTypeInformation -Path $outcsv
exit 0
# SIG # Begin signature block
# MIITYwYJKoZIhvcNAQcCoIITVDCCE1ACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwnJk97wi+tJMb0Wz4IVfgmca
# P/yggg/XMIIHeTCCBWGgAwIBAgIKGCSiEAAAAAAAAjANBgkqhkiG9w0BAQsFADAU
...
# J0SDqCKt30GbzQUokLw1jqGZ9AUwDQYJKoZIhvcNAQEBBQAEggIAKsdAZvO3byTc
# 0M2AnfqKif5b2oCGRY6SzXJVeiTl1sYI/3nCXsVU+vS2pw+j3ARpoJms0dZP3M7p
# P2InltOYE2JIe2OYA/D609ykSdrK092MPzogBJJyK6rH3Sv4tzlz7cTjWEPmCM5/
# 93QCc4ha+7ulVSuJOBjbf4oobj99HraFEZEnuhMb+QYi5xKPbPfsoXRM0nOIpsLv
# /IcTV/7Winqnsn7wBRTvtK2XjwG5BoLZCD03s4WQWXXNcUrL5AuNEG1Ufse8fgGW
# WfDHzMrDnwUucmBeOzjV+8NvNcNFNhVAhUl4sAXLKQDUw6T5aUXtrnE05KWTjg+P
# 3Yg80EN0jdw1k6+J5bBxm79lv5X3VMFLgDfbkmKSB0pqnAlyjWEhnW4XYRd6nLDH
# Z8q1ElHfWVcqAO1XOI8kJ0AA4nR1s2kxl4QCmDqjgwd/RuysLSwYecFyA3hBOt7y
# 8kiO8YE8nLkRdL1/AUOUFrZjBVXnO8Ifn4sOCUPQIEA+4wL8KVOsFmxdIDdy6Go7
# BtQUrrH7hhrFor43Dv2C0ssTd39cTaWa3WWHMKmyLsss2r+rW1ISB4/sNJPnn53E
# ZMKjiCMl5D+IiyXzTdVuopwL92RozGVVhM1qSwztligNQ9ocXkYeIApyEfgEDd2e
# y17tTiDLJjJj5XFZBJJOaIj/vaKNgks=
